...
@Component({
  selector: 'app-test-initializer-v2',
  templateUrl: './test-initializer-v2.component.html',
  styleUrls: ['./test-initializer-v2.component.css']
})
export class TestInitializerV2Component implements OnInit {
