import { LeafEnsSetupTag } from './../../../shared/models/tags/leaf-ens-setup-tag.model';
import { Component, Input, OnInit, ViewChild } from '@angular/core';
import { NgForm } from '@angular/forms';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { LeafTestTag, BaseTag, Routine, Project, EnsTypeEnum, EnsVariableNameEnum, EnsTagConfiguration } from 'src/app/shared';
import { ProjectService } from '../../services/project.service';

@Component({
  selector: 'app-leaf-ens-setup-tag',
  templateUrl: './leaf-ens-setup-tag.component.html',
  styleUrls: ['./leaf-ens-setup-tag.component.css']
})
export class LeafEnsSetupTagComponent implements OnInit {
  @Input() tag!: LeafEnsSetupTag
  @Input() tags!: BaseTag[]
  ...
  tagToUpdate!: LeafEnsSetupTag
  newTag!: LeafEnsSetupTag
