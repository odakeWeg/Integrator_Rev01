import { LeafIOLinkCommunicationTag } from './../../../shared/models/tags/leaf-IOLink-communication-tag.model';
...
@Component({
  selector: 'app-leaf-iolink-communication-tag',
  templateUrl: './leaf-iolink-communication-tag.component.html',
  styleUrls: ['./leaf-iolink-communication-tag.component.css']
})
export class LeafIOLinkCommunicationTagComponent implements OnInit {
  @Input() tag!: LeafIOLinkCommunicationTag
  @Input() tags!: BaseTag[]
  ...
  tagToUpdate!: LeafIOLinkCommunicationTag
  newTag!: LeafIOLinkCommunicationTag
