import { LeafModbusCommunicationTag } from './../../../shared/models/tags/leaf-modbus-communication-tag.model';
...
@Component({
  selector: 'app-leaf-modbus-communication-tag',
  templateUrl: './leaf-modbus-communication-tag.component.html',
  styleUrls: ['./leaf-modbus-communication-tag.component.css']
})
export class LeafModbusCommunicationTagComponent implements OnInit {
  @Input() tag!: LeafModbusCommunicationTag
  @Input() tags!: BaseTag[]
  ...
  tagToUpdate!: LeafModbusCommunicationTag
  newTag!: LeafModbusCommunicationTag
