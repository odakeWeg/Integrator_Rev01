import { LeafStringWriteTag } from './../../../shared/models/tags/leaf-string-write-tag.model';
...
@Component({
  selector: 'app-leaf-string-write-tag',
  templateUrl: './leaf-string-write-tag.component.html',
  styleUrls: ['./leaf-string-write-tag.component.css']
})
export class LeafStringWriteTagComponent implements OnInit {
  @Input() tag!: LeafStringWriteTag
  @Input() tags!: BaseTag[]
  ...
  tagToUpdate!: LeafStringWriteTag
  newTag!: LeafStringWriteTag
