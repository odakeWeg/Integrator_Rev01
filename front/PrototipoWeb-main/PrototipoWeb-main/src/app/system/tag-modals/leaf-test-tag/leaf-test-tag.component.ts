import { EnsTypeEnum } from './../../../shared/globals/ens-type-enum';
import { EnsVariableNameEnum } from './../../../shared/globals/ens-variable-name-enum';
import { LeafTestTag } from './../../../shared/models/tags/leaf-test-tag.model';
import { Component, Input, OnInit, ViewChild } from '@angular/core';
import { NgForm } from '@angular/forms';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { BaseTag, Routine, Project, EnsTagConfiguration } from 'src/app/shared';
import { ProjectService } from '../../services/project.service';

@Component({
  selector: 'app-leaf-test-tag',
  templateUrl: './leaf-test-tag.component.html',
  styleUrls: ['./leaf-test-tag.component.css']
})
export class LeafTestTagComponent implements OnInit {
  @Input() tag!: LeafTestTag
  @Input() tags!: BaseTag[]
