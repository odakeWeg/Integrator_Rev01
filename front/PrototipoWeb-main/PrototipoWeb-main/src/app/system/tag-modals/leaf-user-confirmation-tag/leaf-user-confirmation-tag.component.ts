import { LeafUserConfirmationTag } from './../../../shared/models/tags/leaf-user-confirmation-tag.model';
...
@Component({
  selector: 'app-leaf-user-confirmation-tag',
  templateUrl: './leaf-user-confirmation-tag.component.html',
  styleUrls: ['./leaf-user-confirmation-tag.component.css']
})
export class LeafUserConfirmationTagComponent implements OnInit {
  @Input() tag!: LeafUserConfirmationTag
  @Input() tags!: BaseTag[]
  ...
  tagToUpdate!: LeafUserConfirmationTag
  newTag!: LeafUserConfirmationTag
