import { LeafUserInputTag } from './../../../shared/models/tags/leaf-user-input-tag.model';
...
@Component({
  selector: 'app-leaf-user-input-tag',
  templateUrl: './leaf-user-input-tag.component.html',
  styleUrls: ['./leaf-user-input-tag.component.css']
})
export class LeafUserInputTagComponent implements OnInit {
  @Input() tag!: LeafUserInputTag
  @Input() tags!: BaseTag[]
  ...
  tagToUpdate!: LeafUserInputTag
  newTag!: LeafUserInputTag
  ...
  listOfVariableToRead: string[] = ["valueRef", "inputValue"]
