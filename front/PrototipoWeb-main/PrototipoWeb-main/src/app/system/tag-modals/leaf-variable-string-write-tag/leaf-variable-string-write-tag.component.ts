import { LeafVariableStringWriteTag } from './../../../shared/models/tags/leaf-variable-string-write-tag.model';
...
@Component({
  ...
  templateUrl: './leaf-variable-string-write-tag.component.html',
  styleUrls: ['./leaf-variable-string-write-tag.component.css']
})
export class LeafVariableStringWriteTagComponent implements OnInit {
  @Input() tag!: LeafVariableStringWriteTag
  @Input() tags!: BaseTag[]
  ...
  tagToUpdate!: LeafVariableStringWriteTag
  newTag!: LeafVariableStringWriteTag
