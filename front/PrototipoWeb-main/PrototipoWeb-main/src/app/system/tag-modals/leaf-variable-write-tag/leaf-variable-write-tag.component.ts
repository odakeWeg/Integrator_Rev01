import { LeafVariableWriteTag } from './../../../shared/models/tags/leaf-variable-write-tag.model';
...
@Component({
  selector: 'app-leaf-variable-write-tag',
  templateUrl: './leaf-variable-write-tag.component.html',
  styleUrls: ['./leaf-variable-write-tag.component.css']
})
export class LeafVariableWriteTagComponent implements OnInit {
  @Input() tag!: LeafVariableWriteTag
  @Input() tags!: BaseTag[]
  ...
  tagToUpdate!: LeafVariableWriteTag
  newTag!: LeafVariableWriteTag
